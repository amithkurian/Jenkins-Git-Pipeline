    ...
    post {
        always {
            script {
                ...
                // Get the last 1000 lines of the log for the email body
                def buildLogSnippet = currentBuild.rawBuild.getLog(1000).join("\n")
                
                // Send email with the log snippet in the body and link to the archived full log
